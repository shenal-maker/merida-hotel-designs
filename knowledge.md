# TreeHouse Boutique Hotel — Knowledge Base
...
## Site issues to fix in the website revamp
...
3. **Massage description is a copy-paste of Tours.** The Massage entry on Guest Services repeats the Tours description verbatim ("For information regarding tours we offer, please stop by reception.") — should describe the massage service instead.
   - Page: https://treehouseboutiquehotel.com/guest-services/

4. **Booking engine identity.** The website's booking link points to direct-book.com, not Little Hotelier as the plan assumed. Worth confirming with Selena which is the actual PMS/booking engine.
   - Pages: https://treehouseboutiquehotel.com/ (homepage CTA) — booking link goes to https://direct-book.com/properties/treehouseboutiquehoteldirect

5. **Phone numbers and which one the bot should call.** Selena gave +52 (999) 268 1456 as the front desk, but the site lists three additional numbers including a separate reservations line (+52 999 931 8352). Confirm which one the bot should surface for each kind of handoff (general desk, reservations, US guests).
   - Pages: https://treehouseboutiquehotel.com/contact/ and https://treehouseboutiquehotel.com/ (footer)
